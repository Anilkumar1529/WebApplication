pipeline {
    ...
    stages {
                ...
                checkout(
                    [
                        ...
                        userRemoteConfigs: [
                            [
                                credentialsId: 'git', 
                                url: 'https://github.com/Kunreddi/WebApplication.git'
                            ]
                        ]
                    ]
                )
        ...
        stage('Building the project') {
            steps {
                        bat 'C:/Users/NuGet/NuGet.exe restore 'C:\Users\Administrator\AppData\Local\Jenkins\.jenkins\workspace\Web-APP\WebApplication1.sln''
